...
type Props = {
    onHeadersChange: (content: Array<TableOfContentsEntry>) => void

};

export function CustomTableOfContentsPlugin({onHeadersChange}: Props) {
  ...
  useEffect(() => {
    ...
    editor.getEditorState().read(() => {
      ...
      onHeadersChange(currentTableOfContents)
    });
