    ...
    return (
        <>
            <div className="bg-base-200">
                ...
                <div className="mr-2 ml-2">
                    <UploadImageDialogBody alreadyLoadedImgUrl={state.imgModel} imgClassname="h-46 w-auto" onImageLoaded={onSetImg} showDialogAction={false} showAlternativeText={false} onClick={() => { }} />
                </div>
            </div>
