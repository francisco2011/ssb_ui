...
export default async function Header({ contentHtml, imgSrc }: props): Promise<JSX.Element> {
    ...
    return (
        <>
            <ul className="menu menu-horizontal navbar  sticky top-10 w-screen bg-base-200 sm:text-sm md:text-md xl:text-xl hidden x:block xs:block sm:block md:hidden lg:hidden xl:hidden 2xl:hidden">
